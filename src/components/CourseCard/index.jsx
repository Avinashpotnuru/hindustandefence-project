...
const CourseCard = ({ item }) => {
  return (
    <Box className="bg-white mx-3 p-8 text-center flex  flex-col  justify-around items-center min-h-[374px] space-y-6">
      ...
      <Box className="space-y-3">
        ...
        <h4 className="text-sm text-center lg:text-lg">
         {item.content}
        </h4>
      </Box>
    </Box>
