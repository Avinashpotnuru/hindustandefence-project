...
const MoreInformation = () => {
  ...
  return (
    <Box className="py-8 md:py-10 lg:py-14 px-5 md:px-8 lg:px-28 bg-[#fff5eb] flex-col justify-center items-center  space-y-8 ">
      <Box className="grid grid-cols-1 gap-2 md:grid-cols-2 lg:gap-8">
      ...
      >
        <h2 className="mt-4 text-3xl font-bold text-center md:text-4xl lg:text-5xl ">
          For More Information on Indian armed force{" "}
          <br className="hidden xl:block" /> Click Below :
        </h2>
        <Box className="grid grid-cols-1 gap-6 md:grid-cols-3 lg:gap-6">
